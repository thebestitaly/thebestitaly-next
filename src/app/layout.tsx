  ...
  return (
    <html lang="it" dir="ltr" className={`${poppins.variable} font-sans`}>
      <head>
        ...
        {/* CSP removed in development for admin functionality */}
        {process.env.NODE_ENV !== 'development' && (
          <meta httpEquiv="Content-Security-Policy" content="connect-src 'self' https://www.googletagmanager.com https://fonts.googleapis.com https://widget.getyourguide.com https://region1.google-analytics.com https://www.google-analytics.com https://analytics.google.com https://cdn.thebestitaly.eu; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://widget.getyourguide.com https://static.cloudflareinsights.com https://cs.iubenda.com https://www.clarity.ms; object-src 'none';" />
        )}
