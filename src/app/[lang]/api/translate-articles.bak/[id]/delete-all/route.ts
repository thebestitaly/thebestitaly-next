...
export async function DELETE(
  ...
  try {
    console.log(`[API] Eliminazione traduzioni per articolo ID: ${id}`);
    ...
    // Trova tutte le traduzioni dell'articolo (esclusa quella italiana)
    ...
    await directus.request(
      deleteItems('articles_translations', translationIds)
    );
    ...
    console.error('[API] Errore nell\'eliminazione traduzioni:', error);
    return NextResponse.json({ 
